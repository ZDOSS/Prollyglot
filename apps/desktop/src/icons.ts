...
export const icons = {
  ...
  captions: icon('<rect x="3" y="5" width="18" height="14" rx="3"/><path d="M7 10h4M7 14h7M16 10h1"/>'),
  screen: icon('<rect x="3" y="4" width="18" height="14" rx="2"/><path d="M8 21h8M12 18v3M8 9h3M8 13h7"/>'),
  models: icon('<path d="m12 2.8 8 4.4v9.6l-8 4.4-8-4.4V7.2l8-4.4Z"/><path d="m4.3 7.4 7.7 4.3 7.7-4.3M12 11.7v9.1"/>'),
  compact: icon('<rect x="7" y="3" width="10" height="18" rx="2"/><path d="M10 7h4M10 17h4"/>'),
  fullView: icon('<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M8 4v16M8 9h13"/>'),
