...
export const RUNTIME_CONTRACT_VERSION = 5 as const;
...
export type VisualCaptureSelection = { "kind": "portalWindow" } | { "kind": "portalDisplay" } | { "kind": "applicationWindow", sourceId: string, } | { "kind": "display", sourceId: string, } | { "kind": "region", displayId: string, region: PixelRect, };
